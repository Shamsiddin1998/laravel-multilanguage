			...
			<ul>
				<li>
					<div class="header-top-left">
						<ul>
							<li class="select-opt">
								<form action="{{ route('change.lang') }}" method="get">
                                    <select name="language" id="language" onchange="this.form.submit()">
                                        <option value="tj" {{ session()->get('locale') == 'tj' ? 'selected' : '' }}>TJ</option>
			        ...
			        <div class="container">
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
			                    <li class=" scroll active"><a href="#home">{{__('main.home')}}</a></li>
			                    <li class="scroll"><a href="#works">how it works</a></li>
			                    <li class="scroll"><a href="#explore">explore</a></li>
			                    <li class="scroll"><a href="#reviews">review</a></li>
			                    <li class="scroll"><a href="#blog">{{__('main.blog')}}</a></li>
			                    <li class="scroll"><a href="#contact">{{__('main.contact')}}</a></li>
			                </ul><!--/.nav -->
			            </div><!-- /.navbar-collapse -->
			        </div><!--/.container-->
			    </nav><!--/nav-->
